...
public class UserTest {
    ...
    public void 날짜_숫자_아닌_경우_테스트() throws Exception {
        assertThatThrownBy(() -> dateInputValidator.ValidateInputDate("a")).isInstanceOf(IllegalArgumentException.class);
    }
    ...
    public void 날짜_범위_테스트(String input) throws Exception {
        assertThatThrownBy(() -> dateInputValidator.ValidateInputDate(input)).isInstanceOf(IllegalArgumentException.class);
    }

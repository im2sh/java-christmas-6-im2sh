...
//        Assertions.assertThatThrownBy(() -> new FoodOrder(orderInputValidator.parseOrders(input))).isInstanceOf(IllegalArgumentException.class);
//    }
//
//    @ParameterizedTest
...
//        assertThatThrownBy(() -> new FoodOrder(orderInputValidator.parseOrders(input))).isInstanceOf(IllegalArgumentException.class);
//    }
//}

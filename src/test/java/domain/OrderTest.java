...
public class OrderTest {
    ...
    public void 입력_메뉴_존재_테스트(String input) throws Exception {
        Assertions.assertThatThrownBy(() -> new FoodOrder(orderInputValidator.parseOrders(input)))
    ...
    public void 주문_문자열_null_테스트(String input) throws Exception {
        assertThatThrownBy(() -> new FoodOrder(orderInputValidator.parseOrders(input))).isInstanceOf(
